...
// Helper to handle framework-agnostic label mapping
...
// Helper to get display name for domain
...
<article className={cards.baseHover}>
  ...
  <div className="flex items-start gap-5 mb-5">
    ...
    <div className="flex-1 min-w-0">
      ...
      {/* Tech Stack - Single row with visual emphasis on primary */}
      ...
      {/* Footer Actions - More prominent CTA */}
