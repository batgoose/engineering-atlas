...
/**
 * Route: /gridstream/games/{id}[?play={index|start|live|end}][&play_seq={sequence}]
 *
...
export default function GridstreamGamePage() {
  ...
  if (error) {
    return (
      ...
      >
        ...
        <Link href="/gridstream/games" style={{ color: '#5a7a90', fontSize: 12 }}>
          ← BACK TO GAME SELECT
        </Link>
      </div>
    );
