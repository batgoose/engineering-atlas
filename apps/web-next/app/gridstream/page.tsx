...
function GamePicker() {
  ...
  return (
    <div className={`${layout.page} bg-atlas-dark pb-16`}>
      <div className={`${layout.container} pt-12 sm:pt-16`}>
        <div className="mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {quickStats.map((stat) => (
            <div key={stat.label} className="p-4 bg-atlas-panel/50 border border-white/5 rounded backdrop-blur-sm">
          ...
          {navCards.map((card) => (
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                <span
                  className={card.status === 'Live' ? badges.success : badges.warning}
                >
                  {card.status}
                </span>
              </div>
        ...
        <div className="p-6 bg-atlas-panel/40 border border-white/5 rounded backdrop-blur-sm">
          ...
          <div className="space-y-2 font-mono text-xs text-slate-500">
            <p>
              Optional replay index: <code className="text-frontend">?play=0</code> (start), <code className="text-frontend">?play=live</code> (latest)
            </p>
            <p>
            ...
            <p className="pt-2 mt-2 border-t border-white/5">
              Find game IDs at{' '}
              <a href={`${API_BASE}/games/?season=2024&week=1`} className="text-frontend hover:text-frontend-light hover:underline transition-colors">
