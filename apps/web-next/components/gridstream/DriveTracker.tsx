    ...
    <div className="hud-panel" style={{ padding: '10px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
        ...
        <span style={{
          ...
          padding: '2px 8px', color: C.amber,
          background: 'rgba(255,182,18,.1)', letterSpacing: '.1em',
        }}>
          {possessionTeam}
        </span>
      </div>
      ...
      <div style={{
        display: 'flex', gap: 24, fontFamily: F.display,
      }}>
      ...
      <div style={{
        ...
        color: C.textDim, letterSpacing: '.06em',
      }}>
        FROM {drive.startSide} {drive.startYardLine}
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      <div style={{
        ...
        color: C.textDim, marginBottom: 2,
      }}>
        {label}
      </div>
      <div style={{
