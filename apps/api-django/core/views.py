...
class CompetencyViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    """
    queryset = Competency.objects.prefetch_related(
        'category', 
    ...
    if DjangoFilterBackend:
        ...
        filterset_fields = ['category', 'competency_type', 'proficiency', 'portfolio_highlight']
...
class ArtifactViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    """
    # Optimized QuerySet
    queryset = Artifact.objects.prefetch_related(
